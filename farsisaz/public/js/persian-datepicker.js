...
var PersianDateParser = function () {
    function PersianDateParser() {
        ...
        this.pattern = {
            ...
            jalalidt: /^[1-4]\d{3}(\/|-|\.)((0?[1-6](\/|-|\.)((3[0-1])|([1-2][0-9])|(0?[1-9])))|((1[0-2]|(0?[7-9]))(\/|-|\.)(30|([1-2][0-9])|(0?[1-9])))) (2[0-3]|[01][0-9]):([0-5][0-9]):([0-5][0-9])$/g
        };
    }
    ...
    _createClass(PersianDateParser, [{
        ...
        value: function parse(inputString) {
            var that = this,
                ...
                jalalidtPat = new RegExp(that.pattern.jalalidt);
            ...
            } else if (jalalidtPat.test(inputString)) {
                /* eslint-disable no-useless-escape */
                persianDateArray = inputString.split(/\/|-|\,|\:|\ /).map(Number);
                /* eslint-enable no-useless-escape */
                console.log(persianDateArray);
